...
export const errorsToProblemDetails = (
  errors: ErrorObject[],
): ProblemDetail[] =>
  errors.map((e) => {
    if (e.keyword === 'additionalProperties')
      return {
        ...
        status: 400,
        detail: `The provided input JSON contained an unexpected property name "${
    ...
    return {
      title: 'Input validation failed',
      status: 400,
      detail: `The value provided for ${toLevel(e)} was invalid: it ${
        e.message
      }.`,
    }
  })
